...
<form action="<%=request.getContextPath()%>/getAllPet.html" method="post" id="search-pet" class="layui-form">
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="breederPhone" autocomplete="off" placeholder="饲养员手机号" class="layui-input">
            </div>
    ...
    <form id="pet-edit-form" style="width: 80%" class="layui-form" lay-filter="pet-edit-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" required lay-verify="required" placeholder="请输入宠物名" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="breed" value="0" title="猫">
                <input type="radio" name="breed" value="1" title="狗">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="breeder" required lay-verify="required" placeholder="请输入主人姓名"
                       autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="breederPhone" required lay-verify="required" placeholder="请输入主人手机"
                       autocomplete="off"
                       class="layui-input">
            </div>
        </div>
